let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `RAHMAN-MD CHANNEL\n *LINK:* https://whatsapp.com/channel/0029Va8TzeF0AgW8dVET3U1w\n\n ${Config.botname} *WORKS*`;
...
smd(
  {
    pattern: "wagroup",
    desc: "TO GET SUPPORT NUMBER OF RAHMAN",
    react: "🗨️",
    category: "user",
    filename: __filename,
  },
  async (message) => {
    const SupportMsg = `RAHMAN-MD WHATSAPP GROUP\n\n *ʟɪɴᴋ:*https://chat.whatsapp.com/JvaJHe9m6N6CMWqTRSAcbp \n\n ${Config.botname} *WORKS*`;
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*HEY RAHMAN IS CURRENTLY ACTIVE! 👾*";
 ...
 smd({
   ...
   try {
     ...
     if (!_0x11eeb1) {
       return await _0x7587f6.reply("_Need fileName, Example: document Rahman | caption_");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x587b99) {
       return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://Rahmantech1/RAHMAN-MD*");
     }
 ...
 let tmpUrl = "https://telegra.ph/file/034990b2d62595148af2e.jpg";
 const secmailData = {};
 smd({
   pattern: "tempmail",
